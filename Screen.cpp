...
void SCREEN::ShowTextMessage(const char* icon, const char* sender, const char* title, const char* body)
{
	HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(body);
	HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(icon, icon, false, 0, sender, title);
}
